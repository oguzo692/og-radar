...
/* Sidebar içindeki resim ortalama */
...
if check_password():
    ...
    # --- TİCKER DÜZENİ (LOGO BURADAN KALDIRILDI) ---
    ...
    with st.sidebar:
        ...
        try:
            ...
            st.markdown("<div style='text-align:center; color:#444;'>[LOGO_YOK]</div>", unsafe_allow_html=True)
