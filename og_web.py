...
# --- 4. HTML ŞABLONLARI ---
w9_matches = """<div class='terminal-row'><span>trabzonspor - gala</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>bvb - hamburg</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>newcastle - sunderland</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>brighton - liverpool</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>fenerbahçe - gaziantep</span><span class='highlight'>xxx</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:xxx</span><span>Tutar: 100 USD</span></div>"""
