...
if check_password():
    ...
    # --- 5. OG FORMLINE ---
        ...
        st.title("📈 OG FormLine | Kupon Analizi")
        tab1, tab2 = st.tabs(["🔥 W2 Analizi", "⏪ W1 Analizi"])
        with tab1:
        ...
        with tab2:
             st.markdown("""<div class='coupon-card' style='border-color: #ff4b4b;'>
                <h3 style='color: #ff4b4b;'>❌ W1 - KAYBETTİ</h3>
        ...
        st.title("📊 OG DashDash Analytics")
        st.info("Algoritmalar hazırlanıyor...")
