...
# --- 4. HTML ŞABLONLARI ---
w7_matches = """<div class='terminal-row'><span>beşiktaş - gala</span><span class='highlight'>???</span></div><div class='terminal-row'><span>köln - bvb</span><span class='highlight'>???</span></div><div class='terminal-row'><span>newcastle - manchester united</span><span class='highlight'>kg</span></div><div class='terminal-row'><span>wolwes - liverpool</span><span class='highlight'>???</span></div><div class='terminal-row'><span>fenerbahçe - samsunspor</span><span class='highlight'>???</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran: 8.89</span><span>Tutar: 100 USD</span></div>"""
