...
if check_password():
    ...
    with st.sidebar:
        ...
        # --- RÜTBE SIRALAMASI (SİDEBARDA GERİ GETİRİLDİ) ---
    ...
    if page == "⚡ ULTRA ATAK":
        ...
        # --- TAHMİN SAYFASI ÜST PANEL (HEM BURADA HEM SİDEBARDA) ---
        st.markdown("<div class='terminal-header'>🏆 GÜNCEL PUAN DURUMU</div>", unsafe_allow_html=True)
