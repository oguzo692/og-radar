...
w2_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>🔜 W2 KUPONU (YAKINDA)</div>{w2_matches}<span class='highlight' style='font-weight:bold;'>YAKINDA 🔜</span></div>"w1_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>⏳ W1 KUPONU (BEKLİYOR)</div>{w1_matches}<span class='highlight' style='font-weight:bold;'>BEKLİYOR ⏳</span></div>"
