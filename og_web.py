...
w7_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>⏳ W7 KUPONU (DEVAM EDİYOR)</div>{w7_matches}<span style='color:#00ff41; font-weight:bold;'>⏳ DEVAM EDİYOR</span></div>"
...
if check_password():
    ...
    if page == "⚡ ULTRA ATAK":
        ...
        bf_equity = float(live_vars.get("bf_equity", 102500))
        ...
        with m3:
            daily_limit_pct = (abs(bf_daily_loss) / (bf_balance * 0.05)) * 100
        ...
        st.markdown(f"""
            <div class='industrial-card'>
                ...
                <div style='background:#111; height:15px; border-radius:10px;'>
                    <div style='background:linear-gradient(90deg, #00ff41, #008f11); width:{current_progress*100}%; height:100%; border-radius:10px;'></div>
                </div>
