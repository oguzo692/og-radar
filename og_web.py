...
w2_matches = """<div class='terminal-row'><span>gala - göztepe</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>chelsea - brighton</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>xxx - bvb</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fenerbahçe - konyaspor</span><span class='highlight'>odd</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.009</span><span>Bahis: 100 USD</span></div>"""
w1_matches = """<div class='terminal-row'><span>erzurumspor - gala</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fulham - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>union berlin - bvb</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>gençlerbirliği - fenerbahçe</span><span class='highlight'>fenerbahçe kazanır ❌</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.00</span><span>Bahis: 100 USD</span></div>"""
