...
w3_matches = """<div class='terminal-row'><span>erzurumspor - gala</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>bournemouth - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>bvb - hsv</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fulham - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fenerbahçe - konyaspor</span><span class='highlight'>odd</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.00</span><span>Bahis: 100 USD</span></div>"""
w2_matches = """<div class='terminal-row'><span>erzurumspor - gala</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>bournemouth - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>bvb - hsv</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fulham - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fenerbahçe - konyaspor</span><span class='highlight'>odd</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.00</span><span>Bahis: 100 USD</span></div>"""
w1_matches = """<div class='terminal-row'><span>erzurumspor - gala</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>bournemouth - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>bvb - hsv</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fulham - chelsea</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>fenerbahçe - konyaspor</span><span class='highlight'>odd</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.00</span><span>Bahis: 100 USD</span></div>"""
w3_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>⏳ W3 KUPONU (BEKLİYOR)</div>{w3_matches}<span class='highlight' style='font-weight:bold;'>SONUÇLANDI ✅</span></div>"
w2_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>⏳ W2 KUPONU (BEKLİYOR)</div>{w2_matches}<span class='highlight' style='font-weight:bold;'>SONUÇLANDI ✅</span></div>"
