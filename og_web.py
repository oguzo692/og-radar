...
# --- 4. HTML ŞABLONLARI ---
w11_matches = """<div class='terminal-row'><span>gala - kocaelispor</span><span class='highlight'>gala w & +2</span></div><div class='terminal-row'><span>bvb - leverkusen</span><span class='highlight'>kg</span></div><div class='terminal-row'><span>crystal palace - newcastle</span><span class='highlight'>crystal palace +1</span></div><div class='terminal-row'><span>liverpool - fulham</span><span class='highlight'>liverpool +2 </span></div><div class='terminal-row'><span>kayserispor - fenerbahçe</span><span class='highlight'>fenerbahçe w & +2</span></div><div class='terminal-row'><span>göztepe - gala</span><span class='highlight'>gala w & +2 ✅</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:14.69</span><span>Tutar: 100 USD</span></div>"""
