...
aktif_soru_2 = live_vars.get("aktif_soru2", "en iyi redd şarkısı")
...
if check_password():
    ...
    if page == "⚡ ULTRA ATAK":
        ...
        with q_col2:
            ...
            u_vote_2 = st.radio("Tahmin (Soru 2)", ["askti bu", "don kisot", "tutmuyor frenler", "nefes bile almadan🫠", "onlar bile üzülürler"], key="v2")
