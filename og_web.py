...
# --- 4. HTML ŞABLONLARI ---
w7_matches = """<div class='terminal-row'><span>beşiktaş - gala</span><span class='highlight'>???</span></div><div class='terminal-row'><span>bvb - bayern</span><span class='highlight'>kg ✅</span></div><div class='terminal-row'><span>newcastle - everton</span><span class='highlight'>newcastle +2 ✅</span></div><div class='terminal-row'><span>liverpool - west ham</span><span class='highlight'>live w & 2+ ✅</span></div><div class='terminal-row'><span>antalyasapor - fenerbahçe </span><span class='highlight'>fenerbahçe w & iy +1 & +2 ❌</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran: 8.89</span><span>Tutar: 100 USD</span></div>"""
...
w7_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>❌ W7 KUPONU (BAŞARISIZ)</div>{w7_matches}<span style='color:#00ff41; font-weight:bold;'>SONUÇLANDI ❌</span></div>"
