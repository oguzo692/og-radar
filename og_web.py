...
w4 ucl_matches = """<div class='terminal-row'><span>sporting - gala</span><span class='highlight'>+3 </span></div><div class='terminal-row'><span>arsenal - chelsea</span><span class='highlight'>arsenal x1 & +2 ✅</span></div><div class='terminal-row'><span>bvb - villereal</span><span class='highlight'>bvb x1 & +2 </span></div><div class='terminal-row'><span>fenerbahçe - roma</span><span class='highlight'>+3 </span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 00</span><span>Bahis: 50 USD</span></div>"""
...
w4 ucl_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>⏳ W4 ucl KUPONU (BEKLİYOR)</div>{w3_matches}<span class='highlight' style='font-weight:bold;'>SONUÇLANDI ❌</span></div>"
...
if page == "⚡ ULTRA ATAK":
    ...
    t1, t2, t3, t4= st.tabs(["⏳ W4 ucl", "❌ W3", "✅ W2", "✅ W1"])
    ...
    with t4:
        st.markdown(w4 ucl_coupon_html, unsafe_allow_html=True)
