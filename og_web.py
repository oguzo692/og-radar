...
# --- 4. HTML ŞABLONLARI ---
w8_matches = """<div class='terminal-row'><span>gala - başakşehir</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>bvb - augsburg</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>chelsea - newcastle</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>liverpool - spurs</span><span class='highlight'>xxx</span></div><div class='terminal-row'><span>karagümrük - fenerbahçe</span><span class='highlight'>fenerbahçe w & +2 </span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran: 0.00</span><span>Tutar: 100 USD</span></div>"""
