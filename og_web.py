...
w3_matches = """<div class='terminal-row'><span>başakşehir - gala</span><span class='highlight'>odd</span></div><div class='terminal-row'><span>arsenal - chelsea</span><span class='highlight'>arsenal x1 & +2</span></div><div class='terminal-row'><span>hoffenheim - bvb</span><span class='highlight'>bvb x2 & +2</span></div><div class='terminal-row'><span>fenerbahçe - beşiktaş</span><span class='highlight'>odd</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.00</span><span>Bahis: 50 USD</span></div>"""
