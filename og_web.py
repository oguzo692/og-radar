...
w2_kar = float(get_num(live_vars, "w2_sonuc", -50))
...
w2_matches = """<div class='terminal-row'><span>gala - göztepe</span><span class='highlight'>gala w</span></div><div class='terminal-row'><span>chelsea - brighton</span><span class='highlight'>chelsea x1 & +2</span></div><div class='terminal-row'><span>bvb - hsv</span><span class='highlight'>bvb +2</span></div><div class='terminal-row'><span>samsunspor - fenerbahçe</span><span class='highlight'>fenerbahçe w</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 0.00</span><span>Bahis: 50 USD</span></div>"""
...
w2_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>⏳ W2 KUPONU (BEKLİYOR)</div>{w2_matches}<span class='highlight' style='font-weight:bold;'>YAKINDA 🔜</span></div>"
