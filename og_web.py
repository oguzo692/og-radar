...
# --- 4. HTML ŞABLONLARI ---
w13_matches = """<div class='terminal-row'><span>gala - fenerbahçe</span><span class='highlight'>gala +2</span></div><div class='terminal-row'><span>bvb - freiburg</span><span class='highlight'>bvb +2</div><div class='terminal-row'><span>arsenal - newcastle</span><span class='highlight'>arsenal w & +2</span></div><div class='terminal-row'><span>liverpool - crystal palace </span><span class='highlight'>liverpool w</span></div><div class='terminal-row'><span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:xx</span><span>Tutar: 100 USD</span></div>"""
