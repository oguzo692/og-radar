...
w5_coupon_html = f"<div class='industrial-card'><div class='terminal-header'>🔥 W5 KUPONU (AKTİF)</div>{w4_matches}<span style='color:#cc7a00; font-weight:bold;'>❌ W4 KUPONU (BAŞARISIZ)</span></div>"
