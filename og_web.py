...
/* --- 🧹 STREAMLIT ÜST BARI VE MENÜLERİ GİZLEME --- */
...
if check_password():
    ...
    if page == "⚡ ULTRA ATAK FON":
        ...
        with col3:
            ...
            <div class='industrial-card'>
                ...
                <div style='text-align:center; padding: 5px 0;'>
                    ...
                    <div style='font-size:10px; color:#888; letter-spacing:2px; margin-top:5px;'>TOPLAM BAŞARI ORANI</div>
                </div>
            </div>
        ...
        # --- 🕒 SON İŞLEMLER (TAM GÜVENLİ PARÇALAYICI) ---
        ...
        if son_islemler_raw:
            ...
            for item in items:
                # Hem | işaretli hem düz yazılı formatı destekler
                if "|" in item:
                    parts = item.split('|')
                    ...
                    # Sheets formatına göre (SOL +$50 ✅) otomatik ayırır
        ...
        """, unsafe_allow_html=True)
        st.info("Kupon verileri Sheets üzerinden manuel yönetilmektedir.")
