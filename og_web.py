...
# --- 4. HTML ŞABLONLARI ---
w7_matches = """<div class='terminal-row'><span>beşiktaş - gala</span><span class='highlight'>gala +1</span></div><div class='terminal-row'><span>köln - bvb</span><span class='highlight'>bvb +2</span></div><div class='terminal-row'><span>newcastle - manchester united</span><span class='highlight'>kg</span></div><div class='terminal-row'><span>wolwes - liverpool</span><span class='highlight'>liverpool +2</span></div><div class='terminal-row'><span>fenerbahçe - samsunspor</span><span class='highlight'>fenerbahçe w & +2 </span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran: 6.50</span><span>Tutar: 100 USD</span></div>"""
...
w2_matches = """<div class='terminal-row'><span>gala - kayserispor</span><span style='color:#00ff41;'>gala iy +1 & w & 2+ ✅</span></div><div class='terminal-row'><span>liverpool - newcastle</span><span style='color:#00ff41;'>+2 & liverpool 1x ✅</span></div><div class='terminal-row'><span>bvb - heidenheim</span><span style='color:#00ff41;'>bvb iy +1 & w & 2+ ✅</span></div><div class='terminal-row'><span>kocaelispor - fenerbahçe</span><span style='color:#00ff41;'>fenerbahçe w & 2+ ✅</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 5.53</span><span>Bet: 100 USD</span></div>"""
...
w7_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>⏳ W7 KUPONU (BEKLİYOR)</div>{w7_matches}<span style='color:#00ff41; font-weight:bold;'>SONUÇLANDI ❌</span></div>"
