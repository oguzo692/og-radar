...
w6_coupon_html = f"<div class='industrial-card'><div class='terminal-header'>🔥 W6 KUPONU (AKTİF)</div>{w6_matches}<span style='color:#cc7a00; font-weight:bold;'>SONUÇ BEKLENİYOR...</span></div>"
