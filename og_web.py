...
# Sayısal verileri güvenli hale getirme
...
w1_kar = safe_float(live_vars.get("w1_sonuc", -100)) 
w2_kar = safe_float(live_vars.get("w2_sonuc", 453))
...
if check_password():
    ...
    if page == "⚡ ULTRA ATAK":
        ...
        # BAR HESAPLARI (Hatasız Render İçin Değişkenlere Atandı)
        target = 6500
        ...
        c1 = "#ffae00" if kasa >= 900 else "#444"
        c2 = "#ffae00" if kasa >= 1200 else "#444"
        c3 = "#ffae00" if kasa >= 1800 else "#444"

        # HEDEF YOLCULUĞU HTML BLOĞU
        target_html = f"""
