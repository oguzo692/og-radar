...
w2_matches = """<div class='terminal-row'><span>gala - göztepe</span><span class='highlight'>gala w</span></div><div class='terminal-row'><span>chelsea - brighton</span><span class='highlight'>chelsea x1 & +2</span></div><div class='terminal-row'><span>bvb - hsv</span><span class='highlight'>bvb +2</span></div><div class='terminal-row'><span>samsunspor - fenerbahçe</span><span class='highlight'>fenerbahçe w</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 5.07</span><span>Bahis: 50 USD</span></div>"""
