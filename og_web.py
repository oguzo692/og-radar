...
og_kasa = float(get_num(live_vars, "oguzo_kasa", kasa))
...
w10_kar = float(get_num(live_vars, "w10_sonuc", +520))
w11_kar = float(get_num(live_vars, "w11_sonuc", -100))
w12_kar = float(get_num(live_vars, "w12_sonuc", -100))
w13_kar = float(get_num(live_vars, "w13_sonuc", -100))

toplam_bahis_kar = w1_kar + w2_kar + w3_kar + w4_kar + w5_kar + w6_kar + w7_kar + w8_kar + w9_kar + w10_kar + w11_kar + w12_kar + w13_kar
...
# --- 4. HTML ŞABLONLARI ---
w13_matches = """<div class='terminal-row'><span>gala - fenerbahçe</span><span class='highlight'>gala +2</span></div><div class='terminal-row'><span>bvb - freiburg</span><span class='highlight'>bvb +2</div><div class='terminal-row'><span>arsenal - newcastle</span><span class='highlight'>arsenal w & +2</span></div><div class='terminal-row'><span>liverpool - crystal palace </span><span class='highlight'>liverpool w</span></div><div class='terminal-row'><span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:6.03</span><span>Tutar: 100 USD</span></div>"""
w12_matches = """<div class='terminal-row'><span>gençlerbirliği - gala</span><span class='highlight'>gala w & +2 ✅</span></div><div class='terminal-row'><span>hoffenheim - bvb</span><span class='highlight'>kg ✅</div><div class='terminal-row'><span>newcastle - bournemouth</span><span class='highlight'>newcastle +2 ❌</span></div><div class='terminal-row'><span>everton - liverpool</span><span class='highlight'>kg ✅</span></div><div class='terminal-row'><span>fenerbahçe - rizespor</span><span class='highlight'>fenerbahçe w & +2 ❌</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:8.5</span><span>Tutar: 100 USD</span></div>"""
w11_matches = """<div class='terminal-row'><span>gala - kocaelispor</span><span class='highlight'>gala w & +2 ❌</span></div><div class='terminal-row'><span>bvb - leverkusen</span><span class='highlight'>kg ❌</span></div><div class='terminal-row'><span>crystal palace - newcastle</span><span class='highlight'>crystal palace +1 ✅</span></div><div class='terminal-row'><span>liverpool - fulham</span><span class='highlight'>liverpool +2 ✅</span></div><div class='terminal-row'><span>kayserispor - fenerbahçe</span><span class='highlight'>fenerbahçe w & +2 ✅</span></div><div class='terminal-row'><span>göztepe - gala</span><span class='highlight'>gala w & +2 ✅</span></div><div class='terminal-row'><span>psg - liverpool</span><span class='highlight'>psg w & +2 ✅</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:27.18</span><span>Tutar: 100 USD</span></div>"""
w10_matches = """<div class='terminal-row'><span>trabzonspor - gala</span><span class='highlight'>kg ✅</span></div><div class='terminal-row'><span>stuttgart - bvb</span><span class='highlight'>bvb +1 ✅</span></div><div class='terminal-row'><span>newcastle - maç yok</span><span class='highlight'>---</span></div><div class='terminal-row'><span>manchester city - liverpool</span><span class='highlight'>manchester city +2 ✅</span></div><div class='terminal-row'><span>fenerbahçe - beşiktaş</span><span class='highlight'>fenerbahçe w ✅</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran:5.2</span><span>Tutar: 100 USD</span></div>"""
...
w3_matches = """<div class='terminal-row'><span>wolfsburg - bvb</span><span class='highlight'>bvb x2 & +2 ✅</span></div><div class='terminal-row'><span>newcastle - brentford</span><span class='highlight'>newcastle +2 ✅</span></div><div class='terminal-row'><span>rizespor - gala</span><span class='highlight'>gala w & +2 ✅</span></div><div class='terminal-row'><span>liverpool - man city</span><span class='highlight'>lıve +1 ✅</span></div><div class='terminal-row'><span>fenerbahçe - gençlerbirliği</span><span class='highlight'>fenerbahçe w & +3 ✅</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 8.79</span><span>Tutar: 100 USD</span></div>"""
w2_matches = """<div class='terminal-row'><span>gala - kayserispor</span><span style='color:#00ff41;'>gala w & iy +1 & 2+ ✅</span></div><div class='terminal-row'><span>liverpool - newcastle</span><span style='color:#00ff41;'>+2 & liverpool 1x ✅</span></div><div class='terminal-row'><span>bvb - heidenheim</span><span style='color:#00ff41;'>bvb w & iy +1 & 2+ ✅</span></div><div class='terminal-row'><span>kocaelispor - fenerbahçe</span><span style='color:#00ff41;'>fenerbahçe w & 2+ ✅</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 5.53</span><span>Tutar: 100 USD</span></div>"""
w1_matches = """<div class='terminal-row'><span>karagümrük - gala</span><span style='color:#ff4b4b;'>gala w & +2 ✅</span></div><div class='terminal-row'><span>bournemouth - liverpool</span><span style='color:#00ff41;'>kg ✅</span></div><div class='terminal-row'><span>union berlin - bvb</span><span style='color:#00ff41;'>iy +1 ✅</span></div><div class='terminal-row'><span>newcastle - aston villa</span><span style='color:#ff4b4b;'>newcastle +2 ❌</span></div><div class='terminal-row'><span>fenerbahçe - göztepe</span><span style='color:#ff4b4b;'>fenerbahçe w ❌</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 7.09</span><span>Tutar: 100 USD</span></div>"""

w13_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>⏳ W13 KUPONU (BEKLİYOR)</div>{w13_matches}<span style='color:#00ff41; font-weight:bold;'>SONUÇ BEKLENİYOR 🔜</span></div>"
w12_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>❌ W12 KUPONU (BAŞARISIZ)</div>{w12_matches}<span style='color:#00ff41; font-weight:bold;'>SONUÇLANDI ❌</span></div>"
w11_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>❌ W11 KUPONU (BAŞARISIZ)</div>{w11_matches}<span style='color:#00ff41; font-weight:bold;'>SONUÇLANDI ❌</span></div>"
w10_coupon_html = f"<div class='industrial-card' style='border-top-color: #00ff41 !important;'><div class='terminal-header' style='color:#00ff41;'>✅ W10 KUPONU (BAŞARILI)</div>{w10_matches}<span style='color:#00ff41; font-weight:bold;'>SONUÇLANDI ✅</span></div>"
...
def build_legacy_fallback_instruments(data):
    return [
        ...
        },
        {
            ...
            "order": 4,
            "legacy_map": {"oguzo": "oguzo_aft_adet"},
        },
        {
            "code": "btc",
            "label": "BTC",
...
if check_password():
    ...
    with st.sidebar:
        ...
        page = st.radio(
            "Menu",
            ["⚡ ULTRA ATAK", "⚽ FORMLINE", "📊 Portföy Takip", "💗 LOVE FUND"],
    ...
    # =========================
        ...
        with col3:
            st.markdown(
                f"""
                <div class='industrial-card' style='height:230px;'>
                    <div class='terminal-header'>🎯 HEDEF DURUMU</div>
                    <div class='terminal-row'><span>ANA PARA</span><span class='highlight'>{fmt_money_usd(ultra_ana_para)}</span></div>
                    <div class='terminal-row'><span>SON HEDEF</span><span class='highlight'>{fmt_money_usd(ultra_final_target)}</span></div>
                    <div class='terminal-row'><span>KALAN</span><span style='color:#cc7a00;' class='highlight'>{fmt_money_usd(remaining_to_final)}</span></div>
                </div>
                """,
                unsafe_allow_html=True
            )
    ...
    # =========================
        ...
        coupon_tabs = st.tabs(["W13", "W12", "W11", "W10", "W9", "W8", "W7", "W6", "W5", "W4", "W3", "W2", "W1"])

        coupon_htmls = [
            w13_coupon_html, w12_coupon_html, w11_coupon_html, w10_coupon_html, w9_coupon_html,
            w8_coupon_html, w7_coupon_html, w6_coupon_html, w5_coupon_html, w4_coupon_html,
            w3_coupon_html, w2_coupon_html, w1_coupon_html
        ]

        for tab, html in zip(coupon_tabs, coupon_htmls):
            with tab:
