...
# --- 4. HTML ŞABLONLARI ---
w5_matches = """<div class='terminal-row'><span>konyaspor - gala</span><span class='highlight'>gala w </span></div><div class='terminal-row'><span>leipzig - bvb</span><span class='highlight'>kg </span></div><div class='terminal-row'><span>man city - newcastle</span><span class='highlight'>man city x1 & +2</span></div><div class='terminal-row'><span>forest - liverpool</span><span class='highlight'>live 2+ </span></div><div class='terminal-row'><span>fenerbahçe - kasımpaşa</span><span class='highlight'>fenerbahçe w & +2 </span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Toplam Oran: 11.00</span><span>Tutar: 100 USD</span></div>"""
