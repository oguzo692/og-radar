...
w4ucl_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>⏳ W4 ucl KUPONU (BEKLİYOR)</div>{w3_matches}<span class='highlight' style='font-weight:bold;'>SONUÇLANDI ❌</span></div>"
