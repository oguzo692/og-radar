...
w1_matches = """<div class='terminal-row'><span>erzurumspor - gala</span><span class='highlight'>gala w & +2</span></div><div class='terminal-row'><span>fulham - chelsea</span><span class='highlight'>chelsea x2 & +2</span></div><div class='terminal-row'><span>bayern - bvb</span><span class='highlight'>+3</span></div><div class='terminal-row'><span>fenerbahçe - konyaspor</span><span class='highlight'>ofenerbahçe w & +2</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 5.3</span><span>Bahis: 50 USD</span></div>"""
