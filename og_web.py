...
w5_coupon_html = f"<div class='industrial-card'><div class='terminal-header'>🔥 W5 KUPONU (AKTİF)</div>{w5_matches}<span style='color:#cc7a00; font-weight:bold;'>❌ W5 KUPONU (BAŞARISIZ)</span></div>"
