...
aktif_soru_1 = live_vars.get("aktif_soru", "BIST 100 endeksi günü 13.430 puanın üzerinde mi kapatacak?")
aktif_soru_2 = live_vars.get("aktif_soru2", "Soru: "Gram altın (XAUTRYG) bugün haftalık kapanışını 6.900 TL üzerinde mi yapacak?")
