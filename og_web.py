...
w4_matches = """<div class='terminal-row'><span>gala - kocaelispor</span><span class='highlight'>gala w +2</span></div><div class='terminal-row'><span>chelsea - hull city</span><span class='highlight'>chelsea w & +2</span></div><div class='terminal-row'><span>bvb - paderborn</span><span class='highlight'>bvb w & +2</span></div><div class='terminal-row'><span>gaziantep - fenerbahçe</span><span class='highlight'>fenerbahçe w</span></div><hr style='border: 0; height: 1px; background: rgba(255,255,255,0.05); margin: 15px 0;'><div class='terminal-row'><span>Oran: 4.80</span><span>Bahis: 50 USD</span></div>"""
...
w4ucl_coupon_html = f"<div class='industrial-card' style='border-top-color: #c58a2c !important;'><div class='terminal-header'>❌ W4 UCL KUPONU (SONUÇLANDI)</div>{w4ucl_matches}<span class='highlight' style='font-weight:bold;'>SONUÇLANDI ❌</span></div>"
